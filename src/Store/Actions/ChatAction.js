import {
  ...
  SEARCH_CHAT_USERS_SUCCESS,
  SEARCH_CHAT_USERS_FAILURE,
...
export function searchChatUsersStart(data) {
  return {
    type: SEARCH_CHAT_USERS_START,
    data,
  };
}

export function searchChatUsersSuccess(data) {
  return {
    type: SEARCH_CHAT_USERS_SUCCESS,
    data,
  };
}

export function searchChatUsersFailure(error) {
  return {
    type: SEARCH_CHAT_USERS_FAILURE,
    error,
  };
}
